                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group has-icon-left">
                                        ...
                                        <div class="position-relative">
                                            <asp:TextBox runat="server" CssClass="form-control" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                                type="number"
                                                MaxLength="20" Placeholder="Price" ID="txt_price" TextMode="SingleLine" />
                                            <div class="form-control-icon">
                                                <i class="bi bi-tag"></i>
                                            </div>
                                            <div class="invalid-feedback">
                                ...
                                <div class="col-12">
                                    <div class="form-group has-icon-left">
                                        ...
                                        <div class="position-relative">
                                            <asp:TextBox runat="server" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                                type="number"
                                                MaxLength="11" CssClass="form-control" Placeholder="Mobile Number" ID="txt_mobile" />
                                            <div class="form-control-icon">
